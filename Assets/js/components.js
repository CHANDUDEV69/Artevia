            ...
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
                    const socialIcons = `
                            ...
                            <a href="#" class="socialIcon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                    ...
                    const footerSocialLinks = document.querySelector(".footerSocialLinks");
                    footerSocialLinks.innerHTML = socialIcons;
